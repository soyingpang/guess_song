...
- 後台有 60 / 30 / 15 秒播放設定。
- 後台播放 iframe 已靜音；前台 iframe 不帶 mute 參數。最新 B1 全球手機模式下，玩家手機不再自己播 YouTube。
